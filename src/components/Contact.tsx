              ...
              <div className="mt-6">
                ...
                <div className="flex gap-4">
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className={`w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                >
