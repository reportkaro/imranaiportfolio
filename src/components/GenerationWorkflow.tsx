          ...
          <div className="mb-6">
            <div className="bg-indigo-50 border border-indigo-200 p-4 rounded-md mb-4">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                <li>Template library: <span className="font-medium">Math_Templates_v2.docx</span></li>
                <li>Content spreadsheet: <span className="font-medium">Grade3_Math_Content.xlsx</span></li>
                <li>Selected tab: <span className="font-medium">Grade 3 - Math</span></li>
                <li>Lessons to generate: <span className="font-medium">3 lessons</span></li>
                <li>Estimated time: <span className="font-medium">~2 minutes</span></li>
              </ul>
            </div>
            
            <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-md">
              <h4 className="font-medium text-yellow-700 mb-2">Preview First Lesson</h4>
              <p className="text-sm text-gray-700 mb-3">Review the first lesson before generating all selected lessons:</p>
