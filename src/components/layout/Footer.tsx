      ...
      <div className="container mx-auto px-6 md:px-8">
        <div className="grid gap-16 grid-cols-1 md:grid-cols-2 lg:grid-cols-7 mb-16">
          ...
          <div className="lg:col-span-3">
            <h3 className="gradient-text inline-block text-3xl font-bold mb-6">Looking to enhance your AI experience?</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
              <div>
                ...
                <div className="flex gap-12 text-muted">
                  <a href="https://github.com/imranmohammed" className="hover:text-accent transition-colors" target="_blank" rel="noopener noreferrer">
                  ...
                  <a href="https://linkedin.com/in/imranmohammed" className="hover:text-accent transition-colors" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                    </svg>
                  </a>
                  <a href="https://twitter.com/imranmohammed" className="hover:text-accent transition-colors" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <h4 className="text-lg font-medium mb-6">Sections</h4>
                <ul className="space-y-4">
                  <li><Link href="#work" className="text-muted hover:text-accent transition-colors">Work</Link></li>
                  <li><Link href="#services" className="text-muted hover:text-accent transition-colors">Services</Link></li>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted">&copy; {year} Imran Mohammed. <span className="text-accent">AI Experience Designer</span></p>
        </div>
      </div>
    </footer>
  );
