...
const featuredProjects: Project[] = [
  ...
  },
  {
    ...
    description:
      'An innovative system that automates the generation of optimized teaching schedules for hundreds of schools across multiple global education programs.',
      ...
      <div className="container mx-auto px-6 md:px-8">
        ...
        <div className="space-y-32 mt-24">
          {featuredProjects.map((project, index) => {
            ...
            const projectUrl =
              project.id === 1 ? '/casestudy/lessonloom' : project.id === 2 ? '/casestudy/scheduler' : `/projects/${project.slug}`;
              ...
              >
                ...
                <div className="md:w-1/2 flex flex-col justify-center relative">
                  ...
                  <div className="relative">
                    <span className="inline-block mb-2 text-sm font-medium bg-gradient-to-r from-accent via-tertiary to-accent bg-[length:200%_auto] bg-clip-text transition-all duration-500 ease-in-out text-foreground group-hover:text-transparent">
                      {project.tagline}
                    </span>
                    <h3 className="text-2xl md:text-3xl font-bold mb-4 bg-gradient-to-r from-accent via-tertiary to-accent bg-[length:200%_auto] bg-clip-text transition-all duration-500 ease-in-out text-foreground group-hover:text-transparent">
                      {project.title}
                    </h3>
                    ...
                    <div className="inline-flex items-center font-medium text-accent group-hover:text-accent/80 transition-colors duration-500 ease-in-out">
                      ...
                      <svg
                        ...
                        className="h-5 w-5 ml-1 group-hover:translate-x-1 transition-transform duration-500 ease-in-out"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
                        <path
