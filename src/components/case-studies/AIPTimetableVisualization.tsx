            ...
            <div className="p-0 h-full bg-white overflow-auto">
              ...
              <div className="grid grid-cols-6 border-b border-gray-200">
                ...
                <div className="p-1 border-r border-gray-200">
                  <div className="bg-amber-50 p-1 rounded text-xs text-amber-800 border border-amber-100">Jolly Phonics</div>
                </div>
                <div className="p-1 border-r border-gray-200">
                  <div className="bg-amber-50 p-1 rounded text-xs text-amber-800 border border-amber-100">Jolly Phonics</div>
                </div>
              ...
              <div className="grid grid-cols-6 border-b border-gray-200">
                ...
                <div className="p-1 border-r border-gray-200">
                  <div className="bg-yellow-50 p-1 rounded text-xs text-yellow-800 border border-yellow-100 mb-1">Mathematics Level A</div>
                  <div className="bg-green-50 p-1 rounded text-xs text-green-800 border border-green-100">Social Studies</div>
                </div>
                <div className="p-1 border-r border-gray-200">
                  <div className="bg-yellow-50 p-1 rounded text-xs text-yellow-800 border border-yellow-100 mb-1">Mathematics Level A</div>
                  <div className="bg-green-50 p-1 rounded text-xs text-green-800 border border-green-100">Social Studies</div>
                ...
                <div className="p-1 border-r border-gray-200">
                  <div className="bg-purple-50 p-1 rounded text-xs text-purple-800 border border-purple-100 mb-1">English Studies</div>
              ...
              <div className="grid grid-cols-6 border-b border-gray-200">
                ...
                <div className="p-1 border-r border-gray-200">
                  <div className="bg-gray-100 p-1 rounded text-xs text-gray-700 border border-gray-200 mb-1">Long Break</div>
                  <div className="bg-purple-50 p-1 rounded text-xs text-purple-800 border border-purple-100">English Studies</div>
                </div>
                <div className="p-1 border-r border-gray-200">
                  <div className="bg-gray-100 p-1 rounded text-xs text-gray-700 border border-gray-200 mb-1">Long Break</div>
                ...
                <div className="p-1 border-r border-gray-200">
                  <div className="bg-gray-100 p-1 rounded text-xs text-gray-700 border border-gray-200 mb-1">Long Break</div>
                  <div className="bg-yellow-50 p-1 rounded text-xs text-yellow-800 border border-yellow-100">Mathematics Level B</div>
                </div>
                <div className="p-1 border-r border-gray-200">
                  <div className="bg-gray-100 p-1 rounded text-xs text-gray-700 border border-gray-200 mb-1">Long Break</div>
                  <div className="bg-red-50 p-1 rounded text-xs text-red-800 border border-red-200 flex items-center justify-between">
              ...
              <div className="grid grid-cols-6 border-b border-gray-200">
                ...
                <div className="p-1">
                  <div className="bg-yellow-50 p-1 rounded text-xs text-yellow-800 border border-yellow-100">Mathematics Level A</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-4 flex-1 overflow-y-auto">
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-700 text-sm">
                  A teacher cannot teach more than one lesson at the same time. Please review to ensure the plan is usable.
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 text-sm">
                  A stream cannot attend more than one lesson at the same time. Please review to ensure the plan is usable.
                </p>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  <button className="px-3 py-1 bg-blue-100 text-blue-700 border border-blue-300 rounded text-sm font-medium">P3A</button>
